  ...
  Widget build(BuildContext context)
  {
    ...
    (
      ...
      (
        ...
        title: Text('이고시요', style: TextStyle(fontFamily: 'Raleway', color: Colors.black, fontWeight: FontWeight.w700, fontSize: 20.0)),
        actions: <Widget>
        [
          Container
          (
            ...
            (
              ...
              [
                ...
                Text('egosiyo.com', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
      ...
      body: StaggeredGridView.count(
        ...
        children: <Widget>[
          _buildTile(
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('내가 원하는 고시원을 찾아보세요', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 16.0)),
                      Text('평균 9개의 견적 도착', style: TextStyle(color: Colors.blueAccent))
                    ],
                  ),
                  Material
                  (
            ...
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => FilterPage())),
          ),
          _buildTile(
            Padding(
              padding: const EdgeInsets.all(24.0),
